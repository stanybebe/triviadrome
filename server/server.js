...
app.use(cors({
  origin: 'https://triviadrome.herokuapp.com/socket.io/?EIO=4&transport=polling' // Replace with the actual origin of your React app
...
const io = require('socket.io')(server, {
  cors: {
    origin:  'https://triviadrome.herokuapp.comsocket.io/?EIO=4&transport=polling', // Replace with the actual origin of your React app
